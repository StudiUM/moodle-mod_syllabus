...
Feature: Duplicate and fill subrubrics
  ...
  Scenario: Test all duplicable sub-rubrics
    ...
    And the identifier of syllabus block "1" under "Calendrier des séances" should contain "8 June"
    ...
    And the identifier of syllabus block "2" under "Calendrier des séances" should contain "22 June"
    ...
    And the identifier of syllabus block "3" under "Calendrier des séances" should contain "22 July"
    ...
    And the identifier of syllabus block "1" under "Calendrier des évaluations" should contain "20 June"
    ...
    And the identifier of syllabus block "2" under "Calendrier des évaluations" should contain "20 July"
    ...
    And the identifier of syllabus block "1" under "Calendrier des séances" should contain "8 June"
    And the identifier of syllabus block "2" under "Calendrier des séances" should contain "22 July"
    And the identifier of syllabus block "1" under "Calendrier des évaluations" should contain "20 July"
